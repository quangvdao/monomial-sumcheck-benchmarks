...
fn bb5_projective_eval_matches_reference() {
    ...
    assert_eq!(got, bb5_eq_gruen_projective_eval_ref(&f, &g, eq_rest));
}
...
fn bb5_delayed_wrapper_matches_generic() {
    ...
    sumcheck_deg2_eq_delayed_bb5(&mut f_generic, &mut g_generic, &suffix_eq, &challenges);
    sumcheck_deg2_eq_delayed_bb5_packed(&mut f_packed, &mut g_packed, &suffix_eq, &challenges);
